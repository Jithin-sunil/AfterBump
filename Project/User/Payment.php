...
$selBookingQuery = "SELECT * FROM tbl_booking WHERE booking_id='" . $booking_id . "'";
...
if (isset($_POST["btn_pay"])) {
    ...
    $updateBookingStatusQuery = "UPDATE tbl_booking SET booking_status='2' WHERE booking_id='" . $booking_id . "'";
    if ($Con->query($updateBookingStatusQuery)) {
