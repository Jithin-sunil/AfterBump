...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="Homepage.php" class="navbar-brand"><i class="fa fa-h-square"></i>AfterBump</a>
               </div>
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="ViewProduct.php" class="smoothScroll">View Products</a></li>
                         <li class="dropdown">
                              <a href="#" class="dropdown-toggle smoothScroll" data-toggle="dropdown">Services <b
                                        class="caret"></b></a>
                              <ul class="dropdown-menu">
                                   <li><a href="ServicePost.php" class="smoothScroll">Post Service</a></li>
                                   <li><a href="ViewServicePost.php" class="smoothScroll">View Posts</a></li>
                                   <li><a href="MyRequest.php" class="smoothScroll">My Requests</a></li>
                                   <li><a href="ViewRequest.php" class="smoothScroll">View Requests</a></li>

                              </ul>
                         </li>
                         <li><a href="MyBooking.php" class="smoothScroll">My Bookings</a></li>
                         <li><a href="MyCart.php" class="smoothScroll">My Cart</a></li>
                          <li class="dropdown">
                              <a href="#" class="dropdown-toggle smoothScroll" data-toggle="dropdown">Report <b
                                        class="caret"></b></a>
                              <ul class="dropdown-menu">
                                   <li><a href="Complaint.php" class="smoothScroll">Complaint</a></li>
                                   <li><a href="Feedback.php" class="smoothScroll">Feedback</a></li>

                              </ul>
                         </li>
                         <li><a href="../Guest/Login.php" class="btn btn-gray ">Logout</a></li>
                    </ul>
               </div>
          </div>
     </section>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <img src="../Assets/Templates/User/Main/images/author-image.jpg"
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                              <img src="../Assets/Templates/User/Main/images/team-image1.jpg" class="img-responsive"
                                   alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.4s">
                              <img src="../Assets/Templates/User/Main/images/team-image2.jpg" class="img-responsive"
                                   alt="">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="team-thumb wow fadeInUp" data-wow-delay="0.6s">
                              <img src="../Assets/Templates/User/Main/images/team-image3.jpg" class="img-responsive"
                                   alt="">
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.4s">
                              <a href="news-detail.html">
                                   <img src="../Assets/Templates/User/Main/images/news-image1.jpg"
                                        class="img-responsive" alt="">
                              </a>
                              <div class="news-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.6s">
                              <a href="news-detail.html">
                                   <img src="../Assets/Templates/User/Main/images/news-image2.jpg"
                                        class="img-responsive" alt="">
                              </a>
                              <div class="news-info">
                    ...
                    <div class="col-md-4 col-sm-6">
                         ...
                         <div class="news-thumb wow fadeInUp" data-wow-delay="0.8s">
                              <a href="news-detail.html">
                                   <img src="../Assets/Templates/User/Main/images/news-image3.jpg"
                                        class="img-responsive" alt="">
                              </a>
                              <div class="news-info">
	...
	-->
                         ...
                         <div class="footer-thumb">
                              ...
                              <div class="latest-stories">
                                   <div class="stories-image">
                                        <a href="#"><img src="../Assets/Templates/User/Main/images/news-image.jpg"
     ...
     <!-- SCRIPTS -->
     <script src="../Assets/Templates/User/Main/js/jquery.js"></script>
     <script src="../Assets/Templates/User/Main/js/bootstrap.min.js"></script>
     <script src="../Assets/Templates/User/Main/js/jquery.sticky.js"></script>
     <script src="../Assets/Templates/User/Main/js/jquery.stellar.min.js"></script>
     <script src="../Assets/Templates/User/Main/js/wow.min.js"></script>
     <script src="../Assets/Templates/User/Main/js/smoothscroll.js"></script>
     <script src="../Assets/Templates/User/Main/js/owl.carousel.min.js"></script>
     <script src="../Assets/Templates/User/Main/js/custom.js"></script>
