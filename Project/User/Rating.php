...
<body>
    <div class="container">
    	...
    	<div class="card">
    		<div class="card-header">Rating Box<p align="right"><a style="border:1px solid;width=:100px;height:100px;color:white;background-color:blue;border-radius:5px;" href="Homepage.php">Home</a></p></div>
    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
                    <input type="hidden" name="txt_tid" id="txt_tid" required="required" value="<?php echo $_GET["pid"];?>" />
	        	</div>
	        	<div class="form-group">
