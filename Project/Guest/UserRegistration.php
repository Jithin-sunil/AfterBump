...
if (isset($_POST['btn_submit'])) {
    ...
    $insQry = "INSERT INTO tbl_user(user_name, user_email, user_address, user_password, user_contact, place_id)
               VALUES('$name', '$email', '$address', '$password', '$contact', '$place')";
    if ($Con->query($insQry)) {
...
<title>AfterBump :: User Registration</title>
...
<div class="registration-card">
  <!-- Left Side (Form) -->
  <div class="reg-left">
    <h3><i class="fas fa-heartbeat"></i> Join AfterBump</h3>
    <form method="post">
      ...
      <div class="form-group">
        <label for="user_district" class="form-label">Select District</label>
        <select name="user_district" id="user_district" class="form-select" onchange="getplace(this.value)" required>
      ...
      <div class="form-group">
        <label for="user_place" class="form-label">Select Place</label>
        <select name="user_place" id="user_place" class="form-select" required>
